...
export const portfolioProjects = [
  {
    id: "discord",
    heading: "Shoptidy",
    subheading: "A Discord Clone",
    description:
      "A Discord Clone. It includes features like video call, chat, user authentication. The application is developed with react + typescript for frontend part, and prisma as backend.",
    imageUrl: "/imgs/projects/p1.png",
    techStack: [
      "TypeScript",
      "React",
      "livekit",
    ...
    sourceCodeUrl: "https://github.com/lucifer-3739/discord.git",
  },
];
